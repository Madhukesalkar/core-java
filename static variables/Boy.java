class Boy{
	 ...
	 static long aadhaar = 678489756307L;
     static long phoneNumber = 9987865709L;
	 static String  dateOfBirth = "10/10/1998";
	 static boolean isAlive = true;
	 static int personId = 678567945;
     static int age = 26;
     static int weight = 55;
     static String height = "5 inches"; 
     static String bloodGroup = "O Negative";
     static String gender = "male";
     static String address = "Mahaveer nagar, Bagalkote"; 	 
...
public static void main(String[] persondetails){
     ...
     System.out.println("The Person is Alive " + isAlive ) ;
